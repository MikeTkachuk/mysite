...
function snapXAxis(a) {
    ...
    let x_norm = Math.hypot(x[0], x[2])
    if (Math.abs(x_norm) < 1e-6){
        return a
    }
...
function normalize(a){
    l1 = Math.hypot(a[0], a[1], a[2])
    l2 = Math.hypot(a[4], a[5], a[6])
    l3 = Math.hypot(a[8], a[9], a[10])
    return [
        a[0]/l1, a[1]/l1, a[2]/l1, 0,
        a[4]/l2, a[5]/l2, a[6]/l2, 0,
        a[8]/l3, a[9]/l3, a[10]/l3, 0,
        ...a.slice(12, 15), 1
    ]
}
...
function draw_axes(){
    ...
    function _draw_vector(x,y, color= '#ff0000'){
        ctx.beginPath();
        ctx.moveTo(50, 50);
